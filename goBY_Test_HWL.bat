...
:::::::::::::: 参数设置::::::::::::::
set svnPan=E:
set dirs=E:\KSFBY-test
set script_bat=C:\acme_totals
set db_config_dirs=C:\acme_totals\acme_config
set db_config_dirs_xml=C:\acme_totals\acme_config\253xml
rem 邮件设置
...
echo f|xcopy /y %db_config_dirs%\java_sap_back\bs\TRFZZZSCALLSAPINVOICEBizTalkOrchestration1PortWs_test.java %WORKING_COPY%\acme-sale\acme-sale-invoice\acme-sale-invoice-domain\src\main\java\com\dbgo\acme\sale\invoice\domain\wsdl\TRFZZZSCALLSAPINVOICEBizTalkOrchestration1PortWs.java
