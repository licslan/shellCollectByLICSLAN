...
:::::::::::::: 参数设置::::::::::::::
set svnPan=E:
set dirs=E:\KSFKY-test
set script_bat=C:\acme_totals
set db_config_dirs=C:\acme_totals\acme_config
set db_config_dirs_xml=C:\acme_totals\acme_config\223xml
rem 邮件设置
...
echo 删除生产的回传文件java
del /q  %WORKING_COPY%\acme-sale\acme-sale-invoice\acme-sale-invoice-domain\src\main\java\com\dbgo\acme\sale\invoice\domain\wsdl\TRFZZZSCALLSAPINVOICEBizTalkOrchestration1PortWs.java
echo 复制测试专用java 回传文件
echo f|xcopy /y %db_config_dirs%\java_sap_back\ky\TRFZZZSCALLSAPINVOICEBizTalkOrchestration1PortWs_test.java %WORKING_COPY%\acme-sale\acme-sale-invoice\acme-sale-invoice-domain\src\main\java\com\dbgo\acme\sale\invoice\domain\wsdl\TRFZZZSCALLSAPINVOICEBizTalkOrchestration1PortWs.java
...
echo user kytest_ftp ky_test >> "%ftpfile%"
rem ------------------------------
echo bin >> "%ftpfile%"
